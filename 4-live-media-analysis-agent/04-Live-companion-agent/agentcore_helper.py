        ...
        policy_document = {
            ...
            "Statement": [
                ...
                },
                {
                    ...
                    "Resource": [f"arn:aws:ssm:{self._region}:{self._account_id}:parameter/viewing-companion/*"],
                },
                {
                    "Sid": "GetMemoryId",
                    "Effect": "Allow",
...
def create_memory_execution_role(region_name: str) -> str:
    """Creates an IAM role for AgentCore Memory execution.
    
    This is a standalone function for creating memory execution roles.
        ...
        "Statement": [
            {
                ...
                "Condition": {
                    ...
                    "ArnLike": {
                        "aws:SourceArn": f"arn:aws:bedrock-agentcore:{region_name}:{account_id}:*"
                    }
                }
            }
        ]
    ...
    policy_document = {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": [
                    f"arn:aws:logs:{region_name}:{account_id}:log-group:/aws/bedrock-agentcore/memory/*"
                ]
            }
        ]
    }
    ...
    try:
        ...
        print(f"❌ Error creating memory execution role: {str(e)}")
        raise
